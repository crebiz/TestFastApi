...
async def get_hydrogen_stations(request: Request):
    """
    수소충전소 정보 페이지를 반환합니다.
    ...
    Returns:
        HTMLResponse: hydrogen_stations.html 템플릿을 렌더링한 응답
    """
    return templates.TemplateResponse("hydrogen_stations.html", {
        "request": request
    })
